...
\author{Mouhamadou Ndim, Juste Raimbault, Bénédicte Bucher, Ana-Maria Raimond, Julien Perret}
...
\renewcommand\TP@maketitle{
	...
	%logo box 1
    	...
    	\begin{minipage}[b][.1\textheight][b]{.15\textwidth}
            ...
            %\includegraphics[width=0.7\linewidth]{./figures/meig_strudel}
    	\end{minipage}
    	&
    	%title box
...
%------------------------------------------------------
	\begin{columns}
		...
		\block[titlewidthscale=0.35]{Context}{
			...
			\begin{itemize}
				\item Suburban densification as a tool for more \emph{sustainable cities} while avoiding many negative externalities linked to center densification (scarcity of space, price increase, housing shortage) \cite{jehling2020densification}
                \vspace{0.5cm}
				\item \emph{Multiple rationalities / conceptions of space} for involved stakeholders (landowners, policy makers, inhabitants) coexist \cite{hartmann2019diversity}
                \vspace{0.5cm}
                \item Considerable \emph{planning challenges} in associated incremental development, need for new policy insights and frameworks \cite{dunnning2020planning}
			\end{itemize}
		}
		%==============================================
...
%------------------------------------------------------
	...
	\begin{columns}
		...
		\block[titlewidthscale=0.3,bodyoffsety=1.8cm,titleoffsety=.1cm]{References}{
            ...
            % rq JR: on attend quand même tous le jour où Latex sera moins du bricolage...
